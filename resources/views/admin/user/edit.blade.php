                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-4 mb-3">
                            <div class="form-floating">
                                <input type="text" name="name"  value="{{$user->name}}" class="form-control" id="floatingRepublica" placeholder="Nome">
                                <label for="floatingRepublica">Nome</label>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 mb-3">
                            <div class="form-floating">
                                <input type="text" name="email" value="{{$user->email}}" class="form-control" id="floatingNacionalidade" placeholder="Email">
